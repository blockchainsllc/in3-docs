...
These benchmarktests aim to test the Incubed version for stability and performance on the server. As a result we can give estimate thewe resources needed in order to serve many clients.
