...
```swift
dependencies: [
    .package(url: "git@git.slock.it:in3/c/in3-swift.git", .branch("develop"))
],
```
*Since the swift-bindings are not released yet, they are only available internally, but soon they will be pushed to github and made public*
